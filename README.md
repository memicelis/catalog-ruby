...
Clone this [repository](https://github.com/memicelis/catalog-ruby.git) to your desired folder.
...
- Clone this [repository](https://github.com/memicelis/catalog-ruby.git) in your local machine with correct branch.
- Run **ruby main.rb**
